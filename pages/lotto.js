...
export default function LottoPage() {
  ...
  <a
    ...
    className="w-auto sm:w-[160px] bg-white text-blue-700 font-semibold rounded-full text-sm sm:text-base px-4 sm:px-6 py-2 sm:py-3 shadow-md border hover:shadow-lg transition text-center"
  >
    회차별 당첨번호
  </a>
  <a
