...
{loading && (
  <div className="flex flex-col items-center mt-8 animate-pulse text-black text-gray-900">
     ...
     AI 분석 중입니다... 잠시만 기다려 주세요.
        ...
        {games.length > 0 && (
          <>
            ...
            <div className="text-sm text-gray-500">이 조합 스샷으로 남겨두면 나중에 확인하기 좋아요 💾</div>
                </div>
          </>
        )}
